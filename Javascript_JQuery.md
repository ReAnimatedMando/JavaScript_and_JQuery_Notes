...
*   Execution Contexts 
    ...
    -   Execution Context;
        *   Every statement in a script lives in one of three execution contexts.
            -   Global - Code that is in the script, but not in a function. There is only one global context on any page.
            -   Function Context - Code that is being run within a function. Each function has its own.
